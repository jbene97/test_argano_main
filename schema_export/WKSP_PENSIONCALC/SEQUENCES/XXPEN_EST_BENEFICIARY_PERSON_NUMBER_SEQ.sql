SQL> DECLARE
  ...
  6  BEGIN
  7    BEGIN
  8      l_ddl := DBMS_METADATA.GET_DDL('SEQUENCE','XXPEN_EST_BENEFICIARY_PERSON_NUMBER_SEQ','WKSP_PENSIONCALC');
 ...
 19      FOR r IN (SELECT text FROM all_source WHERE owner='WKSP_PENSIONCALC' AND name='XXPEN_EST_BENEFICIARY_PERSON_NUMBER_SEQ' ORDER BY line) LOOP
