SQL> DECLARE
  ...
  6  BEGIN
  7    BEGIN
  8      l_ddl := DBMS_METADATA.GET_DDL('INDEX','XXPEN_HR_PENSION_CAL_TBL','WKSP_PENSIONCALC');
 ...
 23  END;
 24  /
--ERROR:ORA-31603: object "XXPEN_HR_PENSION_CAL_TBL" of type INDEX not found in schema "WKSP_PENSIONCALC"
