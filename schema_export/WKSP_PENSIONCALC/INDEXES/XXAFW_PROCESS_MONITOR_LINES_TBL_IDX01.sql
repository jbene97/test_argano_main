SQL> DECLARE
  ...
  6  BEGIN
  7    BEGIN
  8      l_ddl := DBMS_METADATA.GET_DDL('INDEX','XXAFW_PROCESS_MONITOR_LINES_TBL_IDX01','WKSP_PENSIONCALC');
 ...
 19      FOR r IN (SELECT text FROM all_source WHERE owner='WKSP_PENSIONCALC' AND name='XXAFW_PROCESS_MONITOR_LINES_TBL_IDX01' ORDER BY line) LOOP
