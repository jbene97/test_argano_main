SQL> DECLARE
  ...
  6  BEGIN
  7    BEGIN
  8      l_ddl := DBMS_METADATA.GET_DDL('TABLE','OLD_EMPID_TO_NEW_EMPID_XREF_28JAN','WKSP_PENSIONCALC');
 ...
 19      FOR r IN (SELECT text FROM all_source WHERE owner='WKSP_PENSIONCALC' AND name='OLD_EMPID_TO_NEW_EMPID_XREF_28JAN' ORDER BY line) LOOP
