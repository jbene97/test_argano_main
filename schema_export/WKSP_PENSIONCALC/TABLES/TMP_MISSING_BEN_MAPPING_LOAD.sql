SQL> DECLARE
  ...
  6  BEGIN
  7    BEGIN
  8      l_ddl := DBMS_METADATA.GET_DDL('TABLE','TMP_MISSING_BEN_MAPPING_LOAD','WKSP_PENSIONCALC');
 ...
 19      FOR r IN (SELECT text FROM all_source WHERE owner='WKSP_PENSIONCALC' AND name='TMP_MISSING_BEN_MAPPING_LOAD' ORDER BY line) LOOP
