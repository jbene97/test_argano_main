SQL> DECLARE
  ...
  6  BEGIN
  7    BEGIN
  8      l_ddl := DBMS_METADATA.GET_DDL('TABLE','XXPEN_HR_SICK_LEAVE_TBL','WKSP_PENSIONCALC');
 ...
 23  END;
 24  /
--ERROR:ORA-31603: object "XXPEN_HR_SICK_LEAVE_TBL" of type TABLE not found in schema "WKSP_PENSIONCALC"
